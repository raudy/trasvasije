...
class DetailsControllerTest < ActionController::TestCase
  ...
  test "should create detail" do
    assert_difference('Detail.count') do
      post :create, detail: { cantidad: @detail.cantidad, hh: @detail.hh, invoice_id: @detail.invoice_id, product_id: @detail.product_id }
    end
  ...
  test "should update detail" do
    patch :update, id: @detail, detail: { cantidad: @detail.cantidad, hh: @detail.hh, invoice_id: @detail.invoice_id, product_id: @detail.product_id }
    assert_redirected_to detail_path(assigns(:detail))
  end
